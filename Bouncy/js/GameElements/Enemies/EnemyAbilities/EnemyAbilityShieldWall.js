class EnemyAbilityShieldWall extends EnemyAbility {
  doEffects(boardState) {
    for (var i = -1; i <= 1; i++) {
      ...
      var targetPoint = {x: this.unit.x + Unit.UNIT_SIZE * i, y: this.unit.y + Unit.UNIT_SIZE};
      ...
      if (
        ...
        EnemyAbilityShieldWall.abilityDef.doActionOnTick('enemy', 0, boardState, castPoint, targetPoint);
      }
    }
  }
}
