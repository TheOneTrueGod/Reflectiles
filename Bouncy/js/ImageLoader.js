class ImageLoader {
  static loadImages(callback) {
    PIXI.loader
      ...
      .add(
        "enemy_boss_wizard_2",
        "/Bouncy/assets/enemies/enemy_boss_wizard_2.png"
      )
      ...
      .add(
        "sprite_lightning_explosion",
        "/Bouncy/assets/sprites/lightning_explosion.png"
      )
  ...
  static getEnemyTexture(sprite) {
    if (sprite in ImageLoader.spriteMap) {
      if (typeof ImageLoader.spriteMap[sprite] === typeof 3) {
        ...
        ImageLoader.spriteMap[sprite] = new PIXI.Texture(
          baseTexture,
          new PIXI.Rectangle(x * iWidth, y * iHeight, iWidth, iHeight)
        );
      }
...
ImageLoader.spriteMap = {
  ...
  zone_shield: 5,
  enemy_protector: 6,
  zone_energy_shield: 7,
  enemy_strong: 8,
  enemy_fast: 9,
  enemy_shover: 10,
  enemy_diamond: 11,
  enemy_necromancer: 14,
  enemy_bone_wall: 15,
  enemy_castle_wall: 16,
  enemy_warlock: 17,
  enemy_skeleton: 18,
  enemy_blocker: 20,
  enemy_blocker_active: 21,
  enemy_damage_limit: 22,
  enemy_damage_limit_2: 23,
  zone_blocker_barrier: 24,
  enemy_slime: 25,
  fire_shard_0: 26,
  fire_shard_1: 27,
  fire_shard_2: 28,
